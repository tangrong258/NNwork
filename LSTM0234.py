...
flytime = np.zeros((featime2d.shape[0], 4), dtype='float32')
flytime[:, 0] = featime2d[:, 2]
flytime[:, 1] = featime2d[:, 12]
flytime[:, 2] = featime2d[:, 15]
flytime[:, 3] = featime2d[:, 16]
...
if __name__ == '__main__':
    ...
    root = r"D:\ZSNJAP01\flight\prediction\LSTM0234" + "\\" + howlong
    sub = "lineavgt"
